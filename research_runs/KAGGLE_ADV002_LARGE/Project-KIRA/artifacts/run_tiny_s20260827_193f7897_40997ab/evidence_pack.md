...
**Run ID:** `run_tiny_s20260827_193f7897_40997ab`  
**Git Commit:** `40997ab`  
...
- **Mean Evasion Distance (MED):** None

## 6. Coevolution Generalisation Loop

| Round | Champion | Challenger | Seen ASR | Held-out ASR | Generalisation Retention | Promoted |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | blue_r0_baseline | challenger_r1 | 0.00% | 0.00% | 1.1430 | No |
| 1 | blue_r0_baseline | challenger_r2 | 0.00% | 0.00% | 1.0000 | No |
| 2 | blue_r0_baseline | challenger_r3 | 0.00% | 0.00% | 1.3071 | No |
| 3 | blue_r0_baseline | challenger_r4 | 0.00% | 0.00% | 1.3071 | No |

**ASR Progression:**
- Baseline Round 0: Seen ASR = `0.00%`, Held-out ASR = `0.00%`
